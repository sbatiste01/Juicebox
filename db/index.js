...
const client = new Client({
  connectionString: process.env.DATABASE_URL || 'postgres://localhost:5432/juicebox_dev2',
...
async function deletePostById(postId) {
  ...
  `, [postId]);
    ...
    const result = {
      posttagsRowsDeleted: posttagsResult.rowCount,
      postRowsDeleted: postResult.rowCount
    }
